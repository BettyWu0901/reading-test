...
def get_mock_quiz():
    """備用題庫"""
    return {
        "qa_questions": [{"id": 1, "question": "為什麼真由美會長出魚鱗？(這是備用題庫，代表 AI 設定失敗)", "score": 20}],
        "mc_questions": [
